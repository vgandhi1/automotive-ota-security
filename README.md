...
📊 **[Live Presentation](https://vgandhi1.github.io/automotive-key-provisioner/)** · [Static slides](presentation.html) · [Slide outline](PRESENTATION.md) *(Pages: **Settings → Pages → Deploy from branch → `gh-pages` / (root)** — not `main`; then run **Deploy GitHub Pages** workflow)*
